...
TTree * SetTruthTree(char* file_path) {
    ...
    chain->Add("/eos/user/m/moriolpe/mphys_project/combined_data.root");
...
int main () {
    ...
    /* INPUT DATA */
    char* file_path= "/eos/user/m/moriolpe/mphys_project/combined_data.root";
    ...
    TFile* output_file = new TFile("/eos/user/m/moriolpe/mphys_project/matched_calib_ttbar.root", "RECREATE");
