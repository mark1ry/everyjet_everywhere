...
int main () {
    ...
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60", &weight_bTagSF_DL1dv01_60);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60", &weight_bTagSF_GN120220509_60);
    ...
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_eigenvars_B_up", &weight_bTagSF_DL1dv01_60_eigenvars_B_up);
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_eigenvars_C_up", &weight_bTagSF_DL1dv01_60_eigenvars_C_up);
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_eigenvars_Light_up", &weight_bTagSF_DL1dv01_60_eigenvars_Light_up);
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_eigenvars_B_down", &weight_bTagSF_DL1dv01_60_eigenvars_B_down);
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_eigenvars_C_down", &weight_bTagSF_DL1dv01_60_eigenvars_C_down);
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_eigenvars_Light_down", &weight_bTagSF_DL1dv01_60_eigenvars_Light_down);
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_extrapolation_from_charm_up", &weight_bTagSF_DL1dv01_60_extrapolation_from_charm_up);
    output_tree_1->Branch("weight_bTagSF_DL1dv01_60_extrapolation_from_charm_down", &weight_bTagSF_DL1dv01_60_extrapolation_from_charm_down);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_eigenvars_B_up", &weight_bTagSF_GN120220509_60_eigenvars_B_up);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_eigenvars_C_up", &weight_bTagSF_GN120220509_60_eigenvars_C_up);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_eigenvars_Light_up", &weight_bTagSF_GN120220509_60_eigenvars_Light_up);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_eigenvars_B_down", &weight_bTagSF_GN120220509_60_eigenvars_B_down);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_eigenvars_C_down", &weight_bTagSF_GN120220509_60_eigenvars_C_down);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_eigenvars_Light_down", &weight_bTagSF_GN120220509_60_eigenvars_Light_down);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_extrapolation_from_charm_up", &weight_bTagSF_GN120220509_60_extrapolation_from_charm_up);
    output_tree_1->Branch("weight_bTagSF_GN120220509_60_extrapolation_from_charm_down", &weight_bTagSF_GN120220509_60_extrapolation_from_charm_down);
    ...
    output_tree_1->Branch("jet_isbtagged_DL1dv01_60", &jet_isbtagged_DL1dv01_60);  
    output_tree_1->Branch("jet_isbtagged_GN120220509_60", &jet_isbtagged_GN120220509_60);  
    output_tree_1->Branch("jet_GN120220509", &jet_GN120220509);
    output_tree_1->Branch("jet_GN120220509_pb", &jet_GN120220509_pb);
    output_tree_1->Branch("jet_GN120220509_pc", &jet_GN120220509_pc);
    output_tree_1->Branch("jet_GN120220509_pu", &jet_GN120220509_pu);
    output_tree_1->Branch("jet_DL1dv01", &jet_DL1dv01);
    output_tree_1->Branch("jet_DL1dv01_pb", &jet_DL1dv01_pb);
    output_tree_1->Branch("jet_DL1dv01_pc", &jet_DL1dv01_pc);
    output_tree_1->Branch("jet_DL1dv01_pu", &jet_DL1dv01_pu);
    ...
    output_tree_1->Branch("ejets_2022_dl1d", &ejets_2022_dl1d);
    output_tree_1->Branch("ejets_2022_gn_lowPt", &ejets_2022_gn_lowPt);
    output_tree_1->Branch("ejets_2022_dl1d_lowPt", &ejets_2022_dl1d_lowPt);
    output_tree_1->Branch("new_ejets_gn_2022", &new_ejets_gn_2022);
    output_tree_1->Branch("new_ejets_dl1d_2022", &new_ejets_dl1d_2022);
    output_tree_1->Branch("mujets_gn_2022", &mujets_gn_2022);
    output_tree_1->Branch("mujets_dl1d_2022", &mujets_dl1d_2022);
    output_tree_1->Branch("mujets_2022_gn_lowPt", &mujets_2022_gn_lowPt);
    output_tree_1->Branch("mujets_2022_dl1d_lowPt", &mujets_2022_dl1d_lowPt);
    output_tree_1->Branch("new_mujets_gn_2022", &new_mujets_gn_2022);
    output_tree_1->Branch("new_mujets_dl1d_2022", &new_mujets_dl1d_2022);
    ...
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60", &weight_bTagSF_DL1dv01_60);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60", &weight_bTagSF_GN120220509_60);
    ...
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_eigenvars_B_up", &weight_bTagSF_DL1dv01_60_eigenvars_B_up);
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_eigenvars_C_up", &weight_bTagSF_DL1dv01_60_eigenvars_C_up);
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_eigenvars_Light_up", &weight_bTagSF_DL1dv01_60_eigenvars_Light_up);
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_eigenvars_B_down", &weight_bTagSF_DL1dv01_60_eigenvars_B_down);
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_eigenvars_C_down", &weight_bTagSF_DL1dv01_60_eigenvars_C_down);
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_eigenvars_Light_down", &weight_bTagSF_DL1dv01_60_eigenvars_Light_down);
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_extrapolation_from_charm_up", &weight_bTagSF_DL1dv01_60_extrapolation_from_charm_up);
    output_tree_2->Branch("weight_bTagSF_DL1dv01_60_extrapolation_from_charm_down", &weight_bTagSF_DL1dv01_60_extrapolation_from_charm_down);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_eigenvars_B_up", &weight_bTagSF_GN120220509_60_eigenvars_B_up);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_eigenvars_C_up", &weight_bTagSF_GN120220509_60_eigenvars_C_up);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_eigenvars_Light_up", &weight_bTagSF_GN120220509_60_eigenvars_Light_up);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_eigenvars_B_down", &weight_bTagSF_GN120220509_60_eigenvars_B_down);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_eigenvars_C_down", &weight_bTagSF_GN120220509_60_eigenvars_C_down);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_eigenvars_Light_down", &weight_bTagSF_GN120220509_60_eigenvars_Light_down);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_extrapolation_from_charm_up", &weight_bTagSF_GN120220509_60_extrapolation_from_charm_up);
    output_tree_2->Branch("weight_bTagSF_GN120220509_60_extrapolation_from_charm_down", &weight_bTagSF_GN120220509_60_extrapolation_from_charm_down);
    ...
    output_tree_2->Branch("jet_isbtagged_DL1dv01_60", &jet_isbtagged_DL1dv01_60);  
    output_tree_2->Branch("jet_isbtagged_GN120220509_60", &jet_isbtagged_GN120220509_60);  
    output_tree_2->Branch("jet_GN120220509", &jet_GN120220509);
    output_tree_2->Branch("jet_GN120220509_pb", &jet_GN120220509_pb);
    output_tree_2->Branch("jet_GN120220509_pc", &jet_GN120220509_pc);
    output_tree_2->Branch("jet_GN120220509_pu", &jet_GN120220509_pu);
    output_tree_2->Branch("jet_DL1dv01", &jet_DL1dv01);
    output_tree_2->Branch("jet_DL1dv01_pb", &jet_DL1dv01_pb);
    output_tree_2->Branch("jet_DL1dv01_pc", &jet_DL1dv01_pc);
    output_tree_2->Branch("jet_DL1dv01_pu", &jet_DL1dv01_pu);
    ...
    output_tree_2->Branch("ejets_2022_dl1d", &ejets_2022_dl1d);
    output_tree_2->Branch("ejets_2022_gn_lowPt", &ejets_2022_gn_lowPt);
    output_tree_2->Branch("ejets_2022_dl1d_lowPt", &ejets_2022_dl1d_lowPt);
    output_tree_2->Branch("new_ejets_gn_2022", &new_ejets_gn_2022);
    output_tree_2->Branch("new_ejets_dl1d_2022", &new_ejets_dl1d_2022);
    output_tree_2->Branch("mujets_gn_2022", &mujets_gn_2022);
    output_tree_2->Branch("mujets_dl1d_2022", &mujets_dl1d_2022);
    output_tree_2->Branch("mujets_2022_gn_lowPt", &mujets_2022_gn_lowPt);
    output_tree_2->Branch("mujets_2022_dl1d_lowPt", &mujets_2022_dl1d_lowPt);
    output_tree_2->Branch("new_mujets_gn_2022", &new_mujets_gn_2022);
    output_tree_2->Branch("new_mujets_dl1d_2022", &new_mujets_dl1d_2022);
